...
public class CreateCSV {
    ...
    public static String getAllProductsAsCsv() {
        ...
        String selectQuery = "SELECT id, transaction_number, name, price, quantity, total, store_name, transaction_date, amount FROM product_transactions WHERE chat_id = ?";

        try (Connection conn = getConnection();
             PreparedStatement pstmt = conn.prepareStatement(selectQuery)) {

            // Устанавливаем значение chatId
